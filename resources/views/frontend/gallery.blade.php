      ...
      >
        ...
        >
          <div class="navbar-nav font-weight-bold mx-auto py-0">
            ...
            <a href="class.blade.php" class="nav-item nav-link">Classes</a>
            <a href="team.blade.php" class="nav-item nav-link">Teachers</a>
            <a href="gallery.blade.php" class="nav-item nav-link active">Gallery</a>
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu rounded-0 m-0">
                ...
                <a href="single.blade.php" class="dropdown-item">Blog Detail</a>
              </div>
            </div>
