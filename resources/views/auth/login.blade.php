                ...
                <div class="col-lg-4 col-md-6 login-fancy-bg bg d-none d-sm-block"
                    ...
                    <div class="login-fancy ">
                        ...
                        <ul class="list-unstyled  pos-bot pb-30 " style="position: absolute; bottom: 20% !important;">
                            <h4 class="mb-20 text-white">قال صلي الله عليه وسلم:</h4>
                            <h4 class="mb-20 text-white">من أراد الدنيا فعليه بالعلم ومن أراد الأخرة فعليه بالعلم ومن أرادهما معا فعلية بالعلم .</h4>
